...
fit_ind <- readRDS("/Users/bbarrett/Downloads/fit_i_60s_slu_all.rds")
...
```{r info criteria , eval=FALSE}
 compare(fit_ind , fit_freq, fit_male , fit_adult , fit_roost , fit_rank , fit_adult_freq , fit_rank_freq , fit_male_freq)
```
