   ...
   //priors
    ...
    for ( i in 1:N ) {
        ...
        if ( bout[i]==1 ) {
            ...
            lambda = exp( mu[1] + I[id[i],1] + A[1,age_index[i]] ) ;
            phi= inv_logit(  mu[2] + I[id[i],2] + A[2,age_index[i]] );
...
generated quantities{
    ...
    for ( i in 1:N ) {
        ...
        if ( bout[i]==1 ) {
            lambda_i[id[i]] = exp( mu[1] + I[id[i],1] + A[1,age_index[i]]) ;
            phi_i[id[i]] = inv_logit(  mu[2] + I[id[i],2] + A[2,age_index[i]]);
        }
